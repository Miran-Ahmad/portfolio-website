        ...
        <Box>
          ...
          <Box>
            <Typography align='justify' className='about-text'>
              ...
              I've always had a deep interest in computers, from playing San Andreas back in the day to adding mods to the game. I developed an interest for Web Developmet only when I was 10, seeing my elder sister write HTML codes in notepad and then view them graphically on Internet Explorer fascinated me. So getting into computer science was something that was almost destined to happen. Although it took some trial and error, I couldn't be more happy that this is that path that I chose.
            </Typography>
